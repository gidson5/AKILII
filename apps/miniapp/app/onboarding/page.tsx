  ...
  return (
    <main className="page-shell" style={{ display: "flex", flexDirection: "column", alignItems: "center", justifyContent: "center", minHeight: "100dvh", padding: "32px 24px" }}>
      <div style={{ width: "100%", maxWidth: "360px", display: "flex", flexDirection: "column", gap: "32px" }}>
        ...
        <div
          style={{ opacity: leaving ? 0 : 1, transform: leaving ? "translateY(8px)" : "translateY(0)", transition: "opacity 0.18s, transform 0.18s", display: "flex", flexDirection: "column", gap: "20px" }}
        >
        ...
        {isLast ? (
          <Link
            ...
            style={{ justifyContent: "center", padding: "14px 28px", borderRadius: "12px", background: "var(--ink)", color: "var(--surface)", textDecoration: "none", fontWeight: 600, fontSize: "0.95rem" }}
          >
            Get started
          </Link>
        ) : (
          <button
            type="button"
            onClick={next}
            style={{ padding: "14px 28px", borderRadius: "12px", background: "var(--ink)", color: "var(--surface)", border: "none", fontWeight: 600, fontSize: "0.95rem", cursor: "pointer" }}
          >
            Next
          </button>
        )}
